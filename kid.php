...
<title>Kids Shirts & Jeans - APRIC</title>
...
<div class="page-heading" id="top" style="background-image: url(../user/assets/images/kidban1.png); margin-top:3px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2 style="margin-top: 80px;">Shirts & Jeans </h2>
...
<!-- End of the while loop -->
 ...
 <footer style="background-color: black; margin-top:80px;">
        <div class="container" style="background-color: black;">
            <div class="row"style="background-color: black; margin-left:30px;">
