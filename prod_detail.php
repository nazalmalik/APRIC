...
<title>APRIC - View Product <?php echo $row['id']['PName']; ?> </title>
...
<div class='container mt-5 ml-10'>
    <div class='row'>
        ...
        <!-- Column 1: Display Image (lg6) -->
        <div class='col-lg-7'>
            <img src='../product/<?php echo $row['PImage']; ?>' alt='' style='height: 300px; margin-left:70px' />
        </div>

        <!-- Column 2: Display Name, Size Options, Quantity, and Add to Cart Button (lg5) -->
        <div class='col-lg-5'>
            <h1 style='font-weight: bold; font-size: 30px;'><?php echo $row['PName']; ?></h1><br>
<h4 ><strong>Price:</strong> Rs. <?php echo $row['PSale']; ?></h4>
            <!-- Size Options -->
            <label for='size'><b>Size:</b></label>
            <select id='size' name='size' class='select-spacing'>
            ...
            <!-- Quantity Options with Increment and Decrement Buttons -->
...
function redirectToNewPage() {
    // You can perform any additional logic here before redirection
    // For example, validate form inputs, etc.
    window.location.href = "addtocart.php";
    return false; // Prevent the form from being submitted via traditional means
}
</script>
