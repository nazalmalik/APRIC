...
<title>Women Bridal Gowns - APRIC</title>
...
<nav class="navbar navbar-expand-lg " style="background-color: black;">
  ...
  <ul class="navbar-nav mr-auto " style="margin-left: 40%;  padding: 6px;">
    ...
    <div class="page-heading1" id="top" style="background-image: url(../user/assets/images/woban1.jpg); margin-top:3px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <!-- <div class="whatsapp_main">
        <a href="https://wa.me/923280809483" target="_blank"><img src="../user/images/whatsapp.png" style="width: 5%;  position:fixed; margin-left: 93%; z-index:1000;"></a>
        </div>   -->
        <div class="whatsapp_main">
